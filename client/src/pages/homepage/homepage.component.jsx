...
class Homepage extends Component  {
    ...
    render() {
        return (
            <Fragment>
                <img src="/images/homepage/landing_img.png" alt="" className="img-fluid" />
                <div className="landing-quote">
                    <p>"We are like Tea, we don't know our strength until we're in hot water"</p>
                    <span><b>- SISTER BUSCHE</b></span>
                </div>
                <div className="img-container">
                    <img src="/images/homepage/freshest_tea_leaf.png" alt="freahest tea leafs" className="img-fluid" />
                ...
                <img src="/images/homepage/plantation_to_cup.png" alt="From Plantation to Your Cup" className="img-fluid" />
                <div className="heading-text">
                    <p>Only the best leaves are harvested from our tea gardens</p>
                </div>
                <div className="img-container">
                    <img src="/images/homepage/tea_leafs.png" alt="tea leafs" className="img-fluid" />
